...
if not os.path.exists(r"C:\Users\Евгений\Desktop\project\10\mad_lib\mad_lib.bat"):
    my_file = open(r"C:\Users\Евгений\Desktop\project\10\mad_lib\mad_lib.bat", "w")
    my_file.write("mad_lib.py\npause")
    my_file.close()
...
class Application(Frame):
    ...
    def create_widgets(self):
        """ Создает элементы управления, с помощью которых пользователь будет вводить
            данные и получать готовый рассказ. """
        ...
        self.is_joyuse = BooleanVar()
        Checkbutton(self,
            text = "радостный",
            variable = self.is_joyuse
        ...
        body_parts = ["рука", "голова", "продолговатый мозг"]
        column = 1
    ...
    def tell_story(self):
        ...
        story += person
        story += " ощутил, как его " + body_part + " скатилась слезинка. "

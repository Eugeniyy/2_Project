# Киноман
# Показывает применение флажков

import os.path

if not os.path.exists(r"C:\Users\Евгений\Desktop\project\10\movie_chooser\movie_chooser.bat"):
    my_file = open(r"C:\Users\Евгений\Desktop\project\10\movie_chooser\movie_chooser.bat", "w")
    my_file.write("movie_chooser.py\npause")
    my_file.close()
...
class Application(Frame):
    ...
    def update_text(self):
        """ Обновлят текстовый элемент по мере того, как пользователь выбирает свои любиые киножанры. """
        likes = ""

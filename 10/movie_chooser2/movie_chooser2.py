# Киноман-2
# Показывает переключатель

import os.path

if not os.path.exists(r"C:\Users\Евгений\Desktop\project\10\movie_chooser2\movie_chooser2.bat"):
    my_file = open(r"C:\Users\Евгений\Desktop\project\10\movie_chooser2\movie_chooser2.bat", "w")
    my_file.write("movie_chooser2.py\npause")
    my_file.close()
